...
class LPZRos(object):
    ...
    def __init__(self, mode="hs"):
        ...
        self.pub_motors  = rospy.Publisher("/lpzbarrel/motors", Float64MultiArray)
        self.sub_sensor = rospy.Subscriber("/lpzbarrel/sensors", Float64MultiArray, self.cb_sensors)
